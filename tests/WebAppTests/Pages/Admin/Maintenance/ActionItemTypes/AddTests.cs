...
public class AddTests
{
    ...
    public async Task OnPost_GivenSuccess_ReturnsRedirectWithDisplayMessage()
    {
        ...
        serviceMock.CreateAsync(Arg.Any<ActionItemTypeCreateDto>(), Arg.Any<CancellationToken>()).Returns(Guid.Empty);
        var validatorMock = Substitute.For<IValidator<ActionItemTypeCreateDto>>();
        validatorMock.ValidateAsync(Arg.Any<ActionItemTypeCreateDto>(), Arg.Any<CancellationToken>())
