        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MailingAddress_Street2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MailingAddress_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MailingAddress_State = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MailingAddress_PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeleteComments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedById = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedById = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaseClosureNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cases_Agencies_ReferralAgencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    AzureAdObjectId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActionItems_AspNetUsers_EnteredById",
                        column: x => x.EnteredById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ActionItems_Cases_CaseworkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_AspNetUsers_EnteredById",
                        column: x => x.EnteredById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionItems_CaseworkId",
                table: "ActionItems",
                column: "CaseworkId");

            migrationBuilder.CreateIndex(
                name: "IX_ActionItems_EnteredById",
                table: "ActionItems",
                column: "EnteredById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cases_ReferralAgencyId",
                table: "Cases",
